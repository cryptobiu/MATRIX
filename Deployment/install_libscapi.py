...
os.system('sudo update-alternatives --install /usr/bin/gcc gcc /usr/bin/gcc-6 60 --slave /usr/bin/g++ g++ /usr/bin/g++-6')

# Install boost 1.64
os.system('wget -O boost_1_64_0.tar.bz2 http://sourceforge.net/projects/boost/files/boost/1.64.0/boost_1_64_0.tar.bz2/download')
os.system('tar --bzip2 -xf boost_1_64_0.tar.bz2')
os.chdir(expanduser('~/boost_1_64_0'))
